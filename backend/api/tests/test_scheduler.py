...
def scheduler(mock_config_service):
    ...
    with patch('backend.api.scheduler.scheduler.ConfigService', return_value=mock_config_service):
...
@pytest.mark.asyncio
async def test_apply_schedule_invalid_schedule(scheduler, mock_config_service, sample_config):
