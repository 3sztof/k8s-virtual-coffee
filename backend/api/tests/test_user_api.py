...
def test_register_user(client, mock_user_service, sample_user, mock_get_current_token_data):
...
def test_get_current_user(client, mock_user_service, sample_user, mock_get_current_token_data):
...
def test_get_current_user_not_found(client, mock_user_service, mock_get_current_token_data):
...
def test_update_user_profile(client, mock_user_service, sample_user, mock_get_current_token_data):
...
def test_update_user_preferences(client, mock_user_service, sample_user, mock_get_current_token_data):
...
def test_toggle_participation(client, mock_user_service, sample_user, mock_get_current_token_data):
    ...
    with patch('backend.api.main.UserService', return_value=mock_user_service):
        ...
        mock_user_service.toggle_participation.assert_called_once_with("test-user-id", True)


def test_get_all_users(client, mock_user_service, sample_user, mock_get_current_token_data):
...
def test_get_all_users_filtered(client, mock_user_service, sample_user, mock_get_current_token_data):
