...
class ConfigService:
    ...
    async def create_config(self, deployment_id: str, config_create: ConfigCreate) -> DeploymentConfig:
        """
    ...
    async def update_config(self, deployment_id: str, config_update: ConfigUpdate) -> Optional[DeploymentConfig]:
        """
    ...
    async def update_schedule(self, deployment_id: str, schedule: str, timezone: Optional[str] = None) -> Optional[DeploymentConfig]:
        """
    ...
    async def update_meeting_size(self, deployment_id: str, meeting_size: int) -> Optional[DeploymentConfig]:
        """
